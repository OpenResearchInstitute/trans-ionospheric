...
<<<<<<< 1c2b2e5204ce4796330e8d46a4def1007c241f96
...
#define MM_ANSWER_MATCH	(MM_NUM_COLORS+1)
#define MM_ANSWER_WHITE	(MM_NUM_COLORS+2)	// right color, wrong column
>>>>>>> Complete on-screen guess picker for Mastermind
...
// These are the graphical colors used to display the various color indexes.
const uint16_t mm_colors[] = {
<<<<<<< 51adb0317c36c4575303e68e904cfa3f74a2d88d
	COLOR_YELLOW, COLOR_RED, COLOR_ORANGE, COLOR_BLUE, COLOR_GREEN, COLOR_WHITE,
>>>>>>> WIP: Implement structure of Mastermind codebreaker UI
=======
	COLOR_YELLOW, COLOR_RED, COLOR_MAGENTA, COLOR_BLUE, COLOR_GREEN, COLOR_WHITE,
>>>>>>> Integrate Mastermind scorer; first playable version
